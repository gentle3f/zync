class LocalizedDomainText {
  ...
  static const Map<String, Map<String, String>> _categories = {
    ...
    'career': {'en':'Careers & Professions','zh-Hant':'職業與專業','zh-Hans':'职业与专业','ja':'キャリア・専門職','ko':'커리어·전문직','es':'Carreras y profesiones','fr':'Carrières et métiers','pt':'Carreiras e profissões'},
  ...
  static const Map<String, Map<String, String>> _taxonomy = {
    ...
    'campus': {'en':'Campus & Student Life','zh-Hant':'校園與學生生活','zh-Hans':'校园与学生生活'},
    'local_culture': {'en':'Local Culture','zh-Hant':'本地文化','zh-Hans':'本地文化'},
    'legal': {'en':'Legal','zh-Hant':'法律專業','zh-Hans':'法律专业'},
    'healthcare': {'en':'Healthcare','zh-Hant':'醫療健康','zh-Hans':'医疗健康'},
    'education': {'en':'Education','zh-Hant':'教育','zh-Hans':'教育'},
    'engineering': {'en':'Engineering & Architecture','zh-Hant':'工程與建築','zh-Hans':'工程与建筑'},
    'finance': {'en':'Finance','zh-Hant':'金融與會計','zh-Hans':'金融与会计'},
    'marketing': {'en':'Marketing','zh-Hant':'市場與營銷','zh-Hans':'市场与营销'},
    'people': {'en':'People & Talent','zh-Hant':'人力資源與人才','zh-Hans':'人力资源与人才'},
    'operations': {'en':'Operations & Supply Chain','zh-Hant':'營運與供應鏈','zh-Hans':'运营与供应链'},
    'technology_careers': {'en':'Technology Careers','zh-Hant':'科技職業','zh-Hans':'科技职业'},
    'science_careers': {'en':'Science & Sustainability Careers','zh-Hant':'科學與可持續職業','zh-Hans':'科学与可持续职业'},
    'research': {'en':'Research & Academia','zh-Hant':'研究與學術','zh-Hans':'研究与学术'},
    ...
    'dance': {'en':'Dance','zh-Hant':'舞蹈','zh-Hans':'舞蹈'},
    'disc_sports': {'en':'Disc Sports','zh-Hant':'飛盤運動','zh-Hans':'飞盘运动'},
    'equestrian': {'en':'Equestrian','zh-Hant':'馬術與騎馬','zh-Hans':'马术与骑马'},
    'endurance': {'en':'Endurance Sports','zh-Hant':'耐力運動','zh-Hans':'耐力运动'},
    'cycling': {'en':'Cycling','zh-Hant':'單車','zh-Hans':'骑行'},
    'fashion': {'en':'Fashion','zh-Hant':'時尚','zh-Hans':'时尚'},
    'family': {'en':'Family & Parenting','zh-Hant':'家庭與育兒','zh-Hans':'家庭与育儿'},
    'fitness': {'en':'Fitness','zh-Hant':'健身','zh-Hans':'健身'},
    'gadgets': {'en':'Gadgets','zh-Hant':'電子裝置','zh-Hans':'电子设备'},
    'hardware': {'en':'Hardware & Making','zh-Hant':'硬件與製作','zh-Hans':'硬件与制作'},
    ...
    'nutrition': {'en':'Nutrition','zh-Hant':'營養與飲食','zh-Hans':'营养与饮食'},
    ...
    'performance': {'en':'Performance','zh-Hant':'表演藝術','zh-Hans':'表演艺术'},
    'precision': {'en':'Precision Sports','zh-Hant':'精準運動','zh-Hans':'精准运动'},
    'recovery': {'en':'Recovery','zh-Hant':'恢復與放鬆','zh-Hans':'恢复与放松'},
    ...
    'shopping': {'en':'Shopping & Browsing','zh-Hant':'購物與逛街','zh-Hans':'购物与逛街'},
    ...
    'audio': {'en':'Audio & Podcasts','zh-Hant':'聲音與 Podcast','zh-Hans':'音频与播客'},
    'live_comedy': {'en':'Live Comedy','zh-Hant':'現場喜劇','zh-Hans':'现场喜剧'},
    'platforms': {'en':'Platforms','zh-Hant':'平台','zh-Hans':'平台'},
    'writing': {'en':'Writing','zh-Hant':'寫作','zh-Hans':'写作'},
    ...
    'media_creation': {'en':'Media Creation','zh-Hant':'媒體創作','zh-Hans':'媒体创作'},
    ...
    'dining': {'en':'Dining & Food Discovery','zh-Hant':'餐飲探索','zh-Hans':'餐饮探索'},
