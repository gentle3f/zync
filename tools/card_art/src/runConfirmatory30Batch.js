// 30-card confirmatory batch after structural scene-prior remediation.
// All cards use Standard FLUX. No auto-rerolls.
...
const BATCH_PATH = path.join(ROOT, 'catalog', 'confirmatory_30_v1.json');
...
console.log(
  `Confirmatory-30 ${batch.version}: ${batch.expected.total_cards} cards; ` +
