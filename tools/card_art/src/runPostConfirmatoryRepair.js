// Targeted 8-card repair gate after Confirmatory-30.
// 7 Standard FLUX cards + American Football protected on Klein. No auto-rerolls.
...
const BATCH_PATH = path.join(ROOT, 'catalog', 'post_confirmatory_repair_v1.json');
...
console.log(
  `Post-confirmatory repair ${batch.version}: ${batch.expected.total_cards} cards; ` +
