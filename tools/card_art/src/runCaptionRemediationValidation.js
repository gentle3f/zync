// 8-card targeted re-validation after global caption suppression and exact recognition fixes.
// No auto-rerolls. Keeps routes aligned with the previous archetype-fix evidence.
...
const BATCH_PATH = path.join(ROOT, 'catalog', 'caption_remediation_validation_v1.json');
...
console.log(
  `Caption-remediation validation ${batch.version}: ${batch.expected.total_cards} cards; ` +
