// 100-card scale validation after the prompt-format root-cause fix.
// Routes 75 ordinary cards through standard FLUX and 25 suppression-sensitive
// cards through FLUX.2 Klein with a real API negative_prompt.
...
const BATCH_PATH = path.join(ROOT, 'catalog', 'scale_100_batch_v1.json');
...
console.log(
  `Scale-100 validation ${batch.version}: ${batch.expected.total_cards} cards; ` +
