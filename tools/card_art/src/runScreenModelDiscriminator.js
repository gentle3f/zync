// Three-call screen-prior model/setting discriminator.
// Uses experiment-only overrides. No production recipe mutation. No auto-rerolls.
...
const BATCH_PATH = path.join(ROOT, 'catalog', 'screen_model_discriminator_v1.json');
...
console.log(
  `Screen model discriminator ${batch.version}: ${batch.expected.api_calls} calls; ` +
