// Targeted 8-card validation for the prompt-format root-cause fix.
// Keeps original model routes so the compiler-format change is the main variable.
...
const BATCH_PATH = path.join(ROOT, 'catalog', 'prompt_format_validation_v1.json');
...
console.log(
  `Prompt-format validation ${batch.version}: ${batch.expected.total_cards} cards; ` +
