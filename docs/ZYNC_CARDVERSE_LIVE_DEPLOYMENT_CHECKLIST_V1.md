...
- PostgreSQL configured and reachable, with the required Cardverse tables/lifecycle columns plus the immutable-ledger trigger and proof-ticket replay unique index present after migrations;
