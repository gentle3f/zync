...
assert.match(privacy, /Share after Zync/i);
assert.match(privacy, /Instagram, Threads, or Facebook/i);
assert.match(privacy, /does not ask for or store your social-media password/i);
assert.match(privacy, /local Zync history on your device/i);
